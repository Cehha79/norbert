...
| **Original-Logo in hoher Auflösung** (07.07., seit 10.07. überholt) | Hasan lehnte den SVG-Nachbau ab — Original soll bleiben. Lösung: Originaldatei in 1595×1600 px vom Strato-Server geholt (transparenter Grund!), nur die **Telefonnummer unten abgeschnitten** (Hasans Vorgabe). Dateien: `bilder/logo.png` (800 px) + `bilder/logo-klein.png` (400 px, für Kopf/Fuß/Favicon) |
| **Neues Logo: goldenes Wappen auf schwarzer Kachel** (10.07., Hasans Anweisung) | Quelle `LOGO/10-topas-sonnengold-emblem.webp`; Kachel ausgemessen und freigestellt, runde Ecken mit Alpha. Palette bleibt Petrol/Gold. Claudes Einwände (Gaming-Formensprache für Zielgruppe 45+; Norbert trägt auf **allen** Arbeitsfotos noch das alte Logo; Abstimmung mit Norbert unbestätigt) sind in der Live-Dokumentation zum 10.07. festgehalten — **vor Livegang mit Norbert klären** |
